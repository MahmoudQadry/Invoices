                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <a class="badge badge-pill badge-warning mr-auto my-auto float-left" href="{{url('MarkAllAsRead')}}">Mark All Read</a>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="unreadedNotifications">You have {{auth()->user()->unreadNotifications()->count()}} unread Notifications</p>
                        </div>
                        <div id="Notifications">
                            @foreach (auth()->user()->unreadNotifications as $notification)
                            <div class="main-notification-list Notification-scroll">
                                <a class="d-flex p-3 border-bottom" href="{{ url('invoiceDetails') }}/{{$notification->data['id']}}/{{$notification->id}}">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <form action="{{route("logout")}}" method="post">
                            @csrf
                            <button type="submit" class="dropdown-item"><i class="bx bx-slider-alt"></i>Sign Out</button>
                        </form>
                        {{-- <a class="dropdown-item" href="{{route("logout")}}"><i class="bx bx-log-out"></i> Sign Out</a> --}}
                    </div>
                </div>
                <div class="dropdown main-header-message right-toggle">
                    <a class="nav-link pr-0" data-toggle="sidebar-left" data-target=".sidebar">
