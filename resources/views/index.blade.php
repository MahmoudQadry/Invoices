				...
				<div class="row row-sm">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{(App\Models\Invoice::count()/App\Models\Invoice::count())*100}}</span>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											 <h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Invoice::where("value_status",1)->sum("total")}}</h4>
											<!-- <p class="mb-0 tx-12 text-white op-7">Compared to last week</p> -->
										</div>
										<span class="float-right my-auto mr-auto">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">Partial paid invoices</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Invoice::where("value_status",2)->sum("total")}}</h4>
											<!-- <p class="mb-0 tx-12 text-white op-7">Compared to last week</p> -->
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Invoice::where("value_status",3)->sum("total")}}</h4>
											<!-- <p class="mb-0 tx-12 text-white op-7">Compared to last week</p> -->
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
