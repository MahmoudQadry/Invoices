...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/archive invoices</span>
            </div>
        </div>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        data-target="#archive_invoice"><i
                                                            class="text-danger fas fa-exchange-alt"></i>delete from archive</a>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action='{{ route("archive.update","test") }}' method="post">
                    ...
                    <div class="modal-body">
                        Are you sure for deleteing from arcive
                        <input type="hidden" name="invoice_id" id="invoice_id" value="">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">close</button>
