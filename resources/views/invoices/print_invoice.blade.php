...
@section('content')
				...
				<div class="row row-sm">
					<div class="col-md-12 col-xl-12">
						<div class=" main-content-body-invoice" id="printdiv">
								...
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>Invoice No</span> <span>{{$invoice->invoice_no}}</span></p>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="tx-right">{{$invoice->commission_amount}}</td>
												...
												<tr>
													...
													<td class="tx-right" colspan="2">{{$invoice->total}}</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="tx-right" colspan="2">
														<h4 class="tx-primary tx-bold">{{$invoice->commission_amount-$invoice->discount-$invoice->value_vat}}</h4>
													</td>
												</tr>
											</tbody>
										</table>
